...
import { ArchiveIcon, FileText, LockIcon, LockOpenIcon } from 'lucide-react'
...
const ResumeTitle: FC<ResumeTitleProps> = ({
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLHeadElement>) => {
        if (e.key === 'Enter') {
            e.preventDefault()
        ...
        <div className='flex items-center gap-1 pr-4'>
            ...
            <span>
                {status === "private" ? (
                    ...
                    <LockOpenIcon className='text-gray-500 dark:text-gray-400' />
                ) : status === "archived" ? (
