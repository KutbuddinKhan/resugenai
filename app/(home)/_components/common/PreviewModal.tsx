      ...
      <Dialog>
        <DialogTrigger asChild>
          <Button
            ...
            variant="secondary"
            className='bg-white border gap-1 dark:bg-gray-600 !p-2 w-9 lg:w-auto lg:p-4'
          > 
            <div className='flex items-center gap-1'>
              <Eye size="17px" />
              <span className='hidden text-sm lg:flex'>Preview</span>
            </div>
          </Button>
        </DialogTrigger>

        <DialogContent
          className='sm:max-w-4xl p-0 w-full max-h-[90vh] lg:max-h-[95vh] overflow-y-auto'
        >
